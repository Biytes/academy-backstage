...
export default {
  ...
  data () {
    return {
      ...
      headmasters: [
        {
          imageUrl: require('@img/teacher/tec1.jpg'),
          name: '李仲麟',
          position: '计算机学院顾问',
        ...
        {
          imageUrl: require('@img/teacher/tec2.jpg'),
          name: '邓春晖',
          position: '计算机学院院长',
          ...
          researchArea: '数据库应用、网格计算和云计算',
          workingExperience: '1970年本科毕业于清华大学自动控制系，分配到天津煤矿专用设备厂工作，1973年底调往大港油田地调指挥部研究大队计算站从事计算机硬件维护工作，1979年到1982年在天津大学计算机系读研究生，获硕士学位，1982年毕业分配到华南理工大学计算机系任教。2000年被评聘为教授。1991年起历任华南理工大学计算机系副主任、电子与信息学院副院长、计算机科学与工程学院副院长，主管教学、实验室等工作。现任华南理工大学广州学院计算机工程学院顾问。'
        },
        {
          imageUrl: require('@img/teacher/tec3.jpg'),
          name: '岑有文',
          position: '计算机学院副院长',
        ...
        {
          imageUrl: require('@img/teacher/tec4.jpg'),
          name: '蔡沂',
          position: '计算机学院副院长',
          ...
          researchArea: '物联网通信协议和节点技术，网络安全',
      ...
      teachers: [
        ...
        {
          name: '王素丽',
          imageUrl: require('@img/teacher/tec6.jpg'),
          educationBackground: '硕士研究生',
          position: '计算机科学与技术教研室副主任/讲师',
          brief: '',
          tel: '',
          email: '',
          researchArea: '计算机应用技术、多媒体技术 ',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '胡赟',
          imageUrl: require('@img/teacher/tec7.jpg'),
          educationBackground: '解放军信息工程大学，本科国防科技大学，工学博士',
          position: '副教授',
          brief: '',
          tel: '',
          email: '',
          researchArea: '智能视频处理，嵌入式系统与软件，通信与信息处理',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '林煜东',
          imageUrl: require('@img/teacher/tec8.jpg'),
          educationBackground: '华南农业大学，工学硕士西南交通大学，工学博士',
          position: '计算机教研室老师',
          brief: '',
          tel: '',
          email: '',
          researchArea: '信号去噪，信号稀疏表示，数字图像处理，人工智能等',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '袁俐萍',
          imageUrl: require('@img/teacher/tec11.jpg'),
          educationBackground: '硕士研究生',
          position: '副教授',
          brief: '',
          tel: '',
          email: '',
          researchArea: '计算机应用、数据库应用、多媒体应用',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '秦映波',
          imageUrl: require('@img/teacher/tec12.jpg'),
          educationBackground: '硕士研究生',
          position: '讲师',
          brief: '',
          tel: '',
        ...
        {
          name: '余小华',
          imageUrl: require('@img/teacher/tec13.jpg'),
          educationBackground: '华南师范大学，工学硕士',
          position: '网络工程教研室主任，副教授',
          brief: '',
          tel: '',
          email: '',
          researchArea: '计算机网络、无线网络和网络安全',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '肖皇培',
          imageUrl: require('@img/teacher/tec14.jpg'),
          educationBackground: '郑州信息工程大学理学学士、华南理工大学工学博士',
          position: '副研究员',
          brief: '',
          tel: '',
          email: '',
          researchArea: '算法设计与分析、网络安全技术、信息安全密码理论、图像处理等',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '阳平华',
          imageUrl: require('@img/teacher/tec17.jpg'),
        ...
        {
          name: '罗世庄',
          imageUrl: require('@img/teacher/tec18.jpg'),
          educationBackground: '大学本科',
          position: '副教授',
          brief: '',
          tel: '',
          email: '',
          researchArea: '应用数学，应用统计',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '詹涌强',
          imageUrl: require('@img/teacher/tec19.jpg'),
          educationBackground: '暨南大学，理学硕士',
          position: '副教授',
          brief: '',
          tel: '',
          email: '',
          researchArea: '微分方程数值解法',
          socialPosition: '',
          achievement: '',
        ...
        {
          name: '杨柱学',
          imageUrl: require('@img/teacher/tec20.jpg'),
          educationBackground: '',
          position: '计算机学院顾问',
          brief: '',
          tel: '',
        ...
        {
          name: '李成炼',
          imageUrl: require('@img/teacher/tec21.jpg'),
          educationBackground: '广东工业大学，工学学士',
          position: '计算机实验中心副主任，实验师',
          brief: '',
          tel: '',
          email: '',
          researchArea: '实验室建设与管理，云计算，大数据分析',
          socialPosition: '',
          achievement: '',
